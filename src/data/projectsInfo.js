export const projectsInfo = [
  {
    url: '/img/projects/avoStore.png',
    name: 'Avo Store',
    description: 'Discover the delicious world of avocado at Avo Store: the online shop specialized in high-quality avocados where you can add your favorites to the shopping cart.',
    features: [
      'SSG with Next',
      'ultra fast',
